          ...
          <div class="panel panel-default" style="background-color:#d4d9d6; ">
            ...
            <div class="panel-body">
              <form action="booking1.jsp" method='post' onchange="getNo" data-toggle="validator" enctype='multipart/form-data'  class="form-horizontal">
                ...
                <form action="com.airlines.user.Booked" method="post" onSubmit="return confirm('Are you sure you wish to book the ticket?');" data-toggle="validator" enctype='multipart/form-data'  class="form-horizontal">
               ...
               <%for(int i=1;i<=3;i++){ %>
               	...
               	<tr>
                	...
                	<td><div class="form-group"><div class="col-lg-12"><input type="text" name='name' class="form-control"  placeholder="passenger  name" required/></div></div></td>
                	
                	<td><div class="form-group"><div class="col-lg-12"><input type="text" name='age' class="form-control" placeholder="passenger age" required/></div></div></td>
                	<td>
                	<div class="form-group">
                	<div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <input type="email" name="name" class="form-control"  id="name" placeholder="Enter your email" required/>
                  </div>
                </div><!--end form group-->
                <div class="form-group">
