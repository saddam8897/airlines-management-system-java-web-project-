    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container bg-light">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span>Greater Noida , UP</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">+91 8287964233</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a >nkvewd@gmail.com.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">visit more</a></p>
          </div>
        </div>
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form action="com.airlines.user.MailDispatcher" method="post">
