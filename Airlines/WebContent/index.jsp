...
<div class="hr"></div>
<div class="foot-lnk">
<a href="forgotPassword.jsp" style="color: #a6b1bf;">Forgot Password?</a>
</div>
</form>
</div>
...
<input id="user" type="text" class="input" name="phone" pattern="(?=.*\d).{10}" required >
</div>

<div class="group">
<label for="pass" class="label" >Password</label>
<input id="pass" type="password" class="input" data-type="password" name="pass" 
pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,14}" title="Must contain at least one number and one uppercase and lowercase letter, and between 8 to 14 characters" required>
</div>
...
<script type="text/javascript">
    function myFunction() {
    	  document.getElementById('myflight').innerHTML = 
    	 
    "<div class=\"container-fluid\"><table class=\"table table-striped\"><thead><tr><th>Flight No</th><th>Flight Name</th><th>From</th><th>To</th><th>Date</th><th>Time</th><th>Airport</th><th>Price</th><th>Book</th></tr></thead></table></div> ";}
    </script>
